...
function setup() {
    ...
    const toucanBody = loadImage('static/images/body.png');
    const toucanTail = loadImage('static/images/tail.png');
    const frontWing = loadImage('static/images/wing_front.png');
    const backWing = loadImage('static/images/wing_back.png');
    const bottomBeak = loadImage('static/images/beak_bottom.png');
    const topBeak = loadImage('static/images/beak_top.png');
    const leftClaw = loadImage('static/images/claw_left.png');
    const rightClaw = loadImage('static/images/claw_right.png');
